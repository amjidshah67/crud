...
<head>
    ...
    <title>Pages / Login - Arsha Bootstrap Template</title>
...
{{--                                <img src="{{ asset('assets/admin/assets/img/logo.png') }}" alt="">--}}
                                <span class="d-none d-lg-block">Arsha Login</span>
                            </a>
                        </div><!-- End Logo -->
                        ...
                        <div class="card mb-3">
                            ...
                            <div class="card-body">
                                ...
                                <form method="post" action="{{ route('postLogin') }}" class="row g-3">
                                    @csrf
                                    <div class="col-12">
                                    ...
                                    <div class="col-12">
                                        <p class="small mb-0">Don't have account? <a href="{{ route('front-register') }}">Create an account</a></p>
                                    </div>
                                </form>
